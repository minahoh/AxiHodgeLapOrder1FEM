function S = create_S_HL_k_1_first(p,t,p2,t2,ed,t_e,basis_p2,basis_nd1,n)
% CREATE_S_HL_K_1_FIRST - Create S matrix
%   Hodge Laplacian k = 1 case, first order
%   (curl_rz^n(zeta_i), curl_rz^n(zeta_j))_r where {zeta_k} is the
%     basis for Bh1
%   (Bh1 is the weighted fourier ND1 and P2 space)
%
% Syntax:
%     S = create_S_HL_k_1_first(p,t,p2,t2,ed,t_e,basis_p2,basis_nd1,n)
%
% Inputs:
