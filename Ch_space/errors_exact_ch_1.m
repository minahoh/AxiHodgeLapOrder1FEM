...
for T = 1:triangles
    ...
    approx_r = @(r,z) x(t_e(T,1)).*basis_rt1_r(r,z,1) + x(edges+t_e(T,1)).*basis_rt1_r(r,z,2)...
        + x(t_e(T,2)).*basis_rt1_r(r,z,3) + x(edges+t_e(T,2)).*basis_rt1_r(r,z,4)...
        + x(t_e(T,3)).*basis_rt1_r(r,z,5) + x(edges+t_e(T,3)).*basis_rt1_r(r,z,6)...
        + x(2*edges+T).*basis_rt1_r(r,z,7)...
        + x(2*edges+triangles+T).*basis_rt1_r(r,z,8);
    
    approx_th = @(r,z) x(t_e(T,1)).*basis_rt1_th(r,z,1) + x(edges+t_e(T,1)).*basis_rt1_th(r,z,2)...
        + x(t_e(T,2)).*basis_rt1_th(r,z,3) + x(edges+t_e(T,2)).*basis_rt1_th(r,z,4)...
        + x(t_e(T,3)).*basis_rt1_th(r,z,5) + x(edges+t_e(T,3)).*basis_rt1_th(r,z,6)...
        + x(2*edges+T).*basis_rt1_th(r,z,7)...
        + x(2*edges+triangles+T).*basis_rt1_th(r,z,8)...
        + x(2*edges+2*triangles+t(1,T)).*basis_p1_th(r,z,1)...
        + x(2*edges+2*triangles+t(2,T)).*basis_p1_th(r,z,2)...
        + x(2*edges+2*triangles+t(3,T)).*basis_p1_th(r,z,3);
    
    approx_z = @(r,z) x(t_e(T,1)).*basis_rt1_z(r,z,1)+x(edges+t_e(T,1)).*basis_rt1_z(r,z,2)...
        + x(t_e(T,2)).*basis_rt1_z(r,z,3) + x(edges+t_e(T,2)).*basis_rt1_z(r,z,4)...
        + x(t_e(T,3)).*basis_rt1_z(r,z,5) + x(edges+t_e(T,3)).*basis_rt1_z(r,z,6)...
        + x(2*edges+T).*basis_rt1_z(r,z,7)...
        + x(2*edges+triangles+T).*basis_rt1_z(r,z,8);
