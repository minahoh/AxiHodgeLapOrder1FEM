function [err_z,err_p] = weighted_HL_k_3_first_e(f,gd,sf,ns,mesh,z_vec_r,z_vec_th,z_vec_z,p_exact,n)
...
%
% Syntax:
%     [err] = weighted_HL_k_3_first_e(f,gd,sf,ns,mesh,z_vec_r,z_vec_th,z_vec_z,p_exact,n)
%     f - given function
...
%    [err_z,err_p] = weighted_HL_k_3_first_e(f,gd,sf,ns,mesh,z_vec_r,z_vec_th,z_vec_z,p_exact,n);
% Dependencies:
%    ../new_ele[mesh].mat.m
