function [err_u,err_s] = weighted_HL_k_2_first(f_vec_r,f_vec_th,f_vec_z,gd,sf,ns,mesh,u_vec_r,u_vec_th,u_vec_z,s_vec_r,s_vec_th,s_vec_z,n)
...
%
% Syntax:
%     [err] = weighted_HL_k_2_first(f_vec_r,f_vec_th,f_vec_z,gd,sf,ns,mesh,u_vec_r,u_vec_th,u_vec_z,s_vec_r,s_vec_th,s_vec_z,n)
...
%    [err_u,err_s] = weighted_HL_k_2_first(f_vec_r,f_vec_th,f_vec_z,gd,sf,ns,mesh,u_vec_r,u_vec_th,u_vec_z,s_vec_r,s_vec_th,s_vec_z,n);
% Dependencies:
%    ../new_ele[mesh].mat
